      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={{ flex: 1, alignItems: "center", justifyContent: 'center'}}>
            <View style={{ alignItems: 'center', marginHorizontal: SIZES.padding}}>
                ...
                <Text style={{color: COLORS.gray, marginTop: SIZES.padding, textAlign: "center", ...FONTS.body3}}> Easy solution to buy tickets for your travel, bussiness trips, Transportantion, lodging and culinary</Text>
            </View>
            <TouchableOpacity
